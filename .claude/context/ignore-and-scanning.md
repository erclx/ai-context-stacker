...
- `src/services/` owns exclude-pattern merging, gitignore-to-glob conversion, and folder-scan batching
- `src/commands/` consumes the merged glob for file-copy operations
